...
dependent = "poke bias (correct %)"
average_bins = "1H"
average_align_start = 12
average_align_days = 2
average_error = "SEM"
shade_dark = True
lights_on = 7
lights_off = 19
...
plot = average_plot_ontime(FEDs, groups, dependent, average_bins, average_align_start, average_align_days, average_error, shade_dark, lights_on, lights_off)