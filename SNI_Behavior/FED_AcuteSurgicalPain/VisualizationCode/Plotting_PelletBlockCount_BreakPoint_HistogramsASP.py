...
#For Haloperidol vs Vehicle
directory_sham = (r'C:\Users\meagh\Box\CreedLabBoxDrive\Jeremy\SNI_Dopamine_Paper\Figure1_SNIBehavior\FED_ASP\Cropped\Pre')
directory_sni = (r'C:\Users\meagh\Box\CreedLabBoxDrive\Jeremy\SNI_Dopamine_Paper\Figure1_SNIBehavior\FED_ASP\Cropped\Post')
#%%
...
result_df_sham.to_csv('ResultPre.csv', index=False)
#%%
#%%
...
# Save the resulting DataFrame to a new .csv file
result_df_sni.to_csv('ResultPost.csv', index=False)
#%%
...
result_df1 = pd.read_csv('ResultPre.csv') #result_df_sham #pd.read_csv('ResultVEH.csv')
result_df2 = pd.read_csv('ResultPost.csv') #result_df_sni #pd.read_csv('ResultHAL.csv')  # Assuming 'result2.csv' is your second DataFrame
...
plt.grid(True)
#plt.show()
plt.savefig('HistogramBlockPelletcount_PrePost_ASP.svg')
