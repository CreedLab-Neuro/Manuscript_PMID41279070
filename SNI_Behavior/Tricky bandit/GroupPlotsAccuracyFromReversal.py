...
directory = r'C:\Users\meagh\Downloads\Clean\Clean\SNI' #SNI/SHAM
...
#directory = r'C:\Users\meagh\Box\CreedLabBoxDrive\Jeremy\SNI_Dopamine_Paper\Figure1_SNIBehavior\FED_Reversal\AcuteReversal'
#%%
...
for i, csv_file in enumerate(csv_files):
    ...
    if "MSNI" in csv_file or "MSHAM" in csv_file:
...
plt.tight_layout()
plt.savefig('SNI_AccuracyBandit.png')
plt.savefig('SNI_AccuracyBandit.svg')
plt.show()
