...
df = pd.read_csv(r'C:\Users\meagh\Box\CreedLabBoxDrive\Jeremy\SNI_Dopamine_Paper\Figure1_SNIBehavior\FED_PR\Chronic\JMTJune24_FED034_MSHAM.csv')
...
# version 1
left_df = df[df['Event'] == 'Poke']  #Left/Pokes
# version 2
...
# Show the plot
plt.tight_layout()
plt.savefig('PokePelletPlot_JMTJune24_SHAM_Blues2.svg')